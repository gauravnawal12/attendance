...
/* ════════════════════════════════════════════════════════════════════
   ...
   ════════════════════════════════════════════════════════════════════ */
const GSheet = {
  /** Returns the Apps Script URL — config.json takes priority over manual setting */
  url() {
    const cfgUrl = APP_CONFIG?.googleSheets?.scriptUrl;
    if (cfgUrl && cfgUrl.includes('script.google.com')) return cfgUrl;
    return Cache.get('apiUrl', null);
  },

  /** True if a valid URL is available */
